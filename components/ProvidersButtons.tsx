...
const buttonsForProviders = () => {
  return (
    <>

    {/*   If you want the Icons to be in Black & White just chnage the fill to " fill="currentColor" "*/}
    ...
    <Button variant="outline" type="button" onClick={() => signInWithTwitter()}>
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
    ...
    <Button variant="outline" type="button" onClick={() => signInWithSpotify()}>
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
    ...
    <Button variant="outline" type="button" onClick={() => signInWithTwitch()}>
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
    ...
    <Button variant="outline" type="button" onClick={() => signInWithSlack()}>
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
    ...
    <Button variant="outline" type="button" onClick={() => signInWithGoogle()}>
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
              <path d="M.778 1.213a.768.768 0 0 0-.768.892l3.263 19.81c.084.5.515.868 1.022.873H19.95a.772.772 0 0 0 .77-.646l3.27-20.03a.768.768 0 0 0-.768-.891zM14.52 15.53H9.522L8.17 8.466h7.561z" fill="#0052CC"/>
            </svg>
...
export default buttonsForProviders